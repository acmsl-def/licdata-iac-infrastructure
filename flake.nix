...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    acmsl-licdata-iac-domain = {
      ...
      url = "github:acmsl-def/licdata-iac-domain/0.0.28";
    };
    ...
    pythoneda-shared-iac-events-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-iac-def/events-infrastructure/0.0.5";
    };
    pythoneda-shared-iac-pulumi-azure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-iac-def/pulumi-azure/0.0.23";
    };
    pythoneda-shared-iac-shared = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-iac-def/shared/0.0.17";
    };
    pythoneda-shared-pythonlang-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    pythoneda-shared-runtime-secrets-events-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-runtime-def/secrets-events-infrastructure/0.0.9";
    };
  };
  outputs = inputs:
    with inputs;
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.18";
        sha256 = "1dpjh4n7xbgrmnfy2cksm0h90jm62clw42k5yk5a1f82k8llacjk";
        pname = "${org}-${repo}";
